#!/usr/bin/env python
#GC-Content-Calculator.py, Python script dat de GC-Content van een DNA bestand kan berekenen
#https://github.com/Plofkip/GC-Content-Calculator
...
#Print de waarde van de GACT variabelen
